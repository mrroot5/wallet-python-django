...
class BussinesAccount(models.Model):
...
class ClientAccount(models.Model):
    ...
    city = models.CharField(max_length=200, null=True, blank=True, unique=False, help_text="Ex. Aranjuez")
    postal_code = models.CharField(max_length=50, null=True, blank=True, unique=False, help_text="Ex. 28000")
    state = models.CharField(max_length=200, null=True, blank=True, unique=False, help_text="Ex. Madrid")
    public_username = models.CharField(max_length=150, null=True, blank=True, unique=False, help_text="Ex. nickname")
...
class BussinesWallet(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid4, editable=False)
...
class BussinesWalletTransaction(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid4, editable=False)
    description = models.CharField(max_length=250, null=True, blank=True, unique=False,
                                   help_text="Transaction description")
    ammount = models.FloatField()
